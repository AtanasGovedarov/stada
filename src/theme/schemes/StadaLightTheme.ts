...
export const StadaLightTheme = createTheme({
  // direction: i18n.dir(),
  colors: {
    gradients: {
  ...
  palette: {
    ...
    bodyBackground: {
      ...
      dark: themeColors.bodyBackground,
    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: {
          ...
          paddingRight: 16,
          borderRadius: 32,
          backgroundColor: themeColors.mag,
          border: '1px solid white',

          '&:hover': {
            background: 'white',
            color: themeColors.mag,
            border: '1px solid ' + themeColors.mag
          },
          '.MuiSvgIcon-root': {
            transition: 'all .2s'
          },
